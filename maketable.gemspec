...
require_relative "lib/maketable/version"

Gem::Specification.new do |spec|
  spec.name = "maketable"
  spec.version = Maketable::VERSION
  spec.authors = ["ykominami"]
  spec.email = ["ykominami@gmail.com"]

  spec.summary = "make table in wiki format from yaml file."
  ...
  spec.metadata["source_code_uri"] = "https://github.com/ykominami/maketable"
